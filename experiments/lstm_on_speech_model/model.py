...
def lstm_on_speech_model(filters=1, kernel_size=16, time_window=640):
    ...
    lstm = tf.keras.layers.LSTM(64, return_sequences=True, input_shape=(time_window, 1))(eeg)
    out1 = tf.keras.layers.LSTM(64, return_sequences=True, input_shape=(time_window, 1))(env1)
    out2 = tf.keras.layers.LSTM(64, return_sequences=True, input_shape=(time_window, 1))(env2)

    dot1 = tf.keras.layers.Dot(0, normalize=True)([lstm, out1])
    dot2 = tf.keras.layers.Dot(0, normalize=True)([lstm, out2])
